...
- `RWTexture2D<float4>` color -- simple hit-surface color from emissive plus direct-lit linear hit albedo, hit metallic, hit normal, and current direct light settings. This is not yet full hit-surface lighting or reflected radiance.
