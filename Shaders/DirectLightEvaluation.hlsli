#ifndef RTPBRSURVEY_DIRECT_LIGHT_EVALUATION_HLSLI
#define RTPBRSURVEY_DIRECT_LIGHT_EVALUATION_HLSLI
...
DirectLightSample EvaluateDirectLightData(LightGpuData light, float3 worldPosition)
{
